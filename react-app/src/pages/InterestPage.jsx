...
<form action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DdM00000vOexx" method="POST">

<input type=hidden name="oid" value="00DdM00000vOexx">
<input type=hidden name="retURL" value="https://react-for-fun.vercel.app/thanks">

<!--  ----------------------------------------------------------------------  -->
<!--  NOTE: These fields are optional debugging elements. Please uncomment    -->
<!--  these lines if you wish to test in debug mode.                          -->
<!--  <input type="hidden" name="debug" value=1>                              -->
<!--  <input type="hidden" name="debugEmail" value="harmathzs@gmail.com">     -->
<!--  ----------------------------------------------------------------------  -->
...
<input type="submit" name="submit">
          ...
          Return URL is set to: https://react-for-fun.vercel.app/thanks 
