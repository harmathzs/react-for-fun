    ...
    <nav className="navbar">
      <div className="navbar-inner">
        ...
        <ul className="navbar-links">
          ...
          {!authenticated && location.pathname === '/login' && <li><NavLink to="/login">Login</NavLink></li>}
          {!authenticated && location.pathname === '/register' && <li><NavLink to="/register">Register</NavLink></li>}
